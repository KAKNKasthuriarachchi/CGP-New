            ...
            {Array.from({ length: 8 }, (_, i) => (
              <div key={i} className="bg-white p-4 rounded shadow-md">
                ...
                <p className="font-bold">
                  Name: <span className="font-normal">Tutor {i + 1}</span>
                </p>
                <p className="font-bold">
                  Section: <span className="font-normal">Primary</span>
                </p>
                <p className="font-bold">
                  Stream: <span className="font-normal">Maths</span>
                </p>
                <p className="font-bold">
                  District: <span className="font-normal">Kandy</span>
                </p>
              </div>
            ))}
          </div>
